...
void IEX::parseSymbolData(const Json::Value &IEXdata, vector<string> &symbolVec)
{
    int i = 0;
...
vector<string> IEX::getSymbolList()
{
    Json::Value jsonData;
    string symbolUrl("https://cloud.iexapis.com/v1/ref-data/iex/symbols?token=pk_e7a450eeb9a64f73ad45618469155cf3");
    vector<string> symbolList;
    IEX::sendGetRequest(jsonData, symbolUrl);
...
{
    vector<string> symbolList = getSymbolList();
    string symbolCopy = symbol;
    if (find(symbolList.begin(), symbolList.end(), symbolCopy) != symbolList.end())
        return true;
...
void IEX::sendGetRequest(Json::Value &jsonData, const string url)
{
 ...
 */
Json::Value IEX::stocks::book(const string &symbol)
{
    Json::Value jsonData;
 ...
 */
Json::Value IEX::stocks::chart(const string &symbol)
{
    Json::Value jsonData;
    ...
    string url(IEX_ENDPOINT);
    url+="/stock/"+symbol+"/intraday-prices?token="+api;
    IEX::sendGetRequest(jsonData, url);
    assert(jsonData.isArray()); //Crash if not an array
    return jsonData;
}

Json::Value IEX::stocks::chartYtd(const string &symbol)
{
    Json::Value jsonData;
    ...
    string api(API_TOKEN);
    string url(IEX_ENDPOINT);
    url+="/stock/"+symbol+"/chart/ytd/?token="+api;
    IEX::sendGetRequest(jsonData, url);
    assert(jsonData.isArray()); //Crash if not an array
    return jsonData;
}
...
Json::Value IEX::stocks::chartRange(const string &symbol, const string &range)
{
    Json::Value jsonData;
    ...
    if(range == "5y" || range == "2y" || range == "1y" || range == "ytd" || range == "6m" || range == "3m" || range == "1m" || range == "1d") {
        ...
        cout << endl << "Incorrect 'range' input in function chartRange. Exiting." << endl;
        exit(1);
    }
    assert(jsonData.isArray()); //Crash if not an array
    return jsonData;
...
Json::Value IEX::stocks::chartDate(const string &symbol, const string &date)
{
    Json::Value jsonData;
    ...
    if(date.size() == 8) {
        ...
        cout << endl << "Incorrect 'date' input in function chartDate. Exiting." << endl;
        exit(1);
    }
    assert(jsonData.isArray()); //Crash if not an array
    return jsonData;
...
Json::Value IEX::stocks::chartDynamic(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::company(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::dividends(const string &symbol, const string &range)
{
    Json::Value jsonData;
    ...
    if(range == "5y" || range == "2y" || range == "1y" || range == "ytd" || range == "6m" || range == "3m" || range == "1m") {
        ...
        cout << endl << "Incorrect 'range' input in function dividends. Exiting." << endl;
        exit(1);
    }
    assert(jsonData.isArray()); //Crash if not an array
    return jsonData;
...
Json::Value IEX::stocks::earnings(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::effectiveSpread(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::financials(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::stats(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::largestTrades(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::list(const string &listType)
{
    Json::Value jsonData;
    if(listType == "mostactive" || listType == "gainers" || listType == "losers" || listType == "iexvolume" || listType == "iexmarketpercent") {
        ...
        cout << endl << "Incorrect 'listType' input in function list(). I am returning an uninitialized JSON object!" << endl;
        return jsonData;
    }
    assert(jsonData.isArray()); //Crash if not an array
    return jsonData;
...
Json::Value IEX::stocks::logo(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::news(const string &symbol, int last)
{
    Json::Value jsonData;
    ...
    string url(IEX_ENDPOINT);
    last == 0 ? url += "/stock/"+symbol+"/news" : url += "/stock/"+symbol+"/news/last/"+to_string(last);
    IEX::sendGetRequest(jsonData, url);
    assert(jsonData.isArray()); //Crash if not an array
    return jsonData;
}
...
Json::Value IEX::stocks::OHLC(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::peers(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::previous(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::price(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::quote(const string &symbol, bool displayPercent)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::relevant(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::splits(const string &symbol, const string &range)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::timeSeries(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::stocks::VolumeByVenue(const string &symbol)
{
    Json::Value jsonData;
...
Json::Value IEX::refData::corporateActions(string date)
{
    Json::Value jsonData;
    string url(IEX_ENDPOINT);
...
Json::Value IEX::refData::dividends(string date)
{
    Json::Value jsonData;
    string url(IEX_ENDPOINT);
    if(!date.empty()) {
...
Json::Value IEX::refData::nextDayExDate(string date)
{
    Json::Value jsonData;
    string url(IEX_ENDPOINT);
    if(!date.empty()) {
...
Json::Value IEX::refData::symbolDirectory(string date)
{
    Json::Value jsonData;
    string url(IEX_ENDPOINT);
    if(!date.empty()) {
...
Json::Value IEX::stats::historical(string date)
{
    Json::Value jsonData;
    string url(IEX_ENDPOINT);
    if(!date.empty()) {
...
Json::Value IEX::stats::historicalDaily(string date)
{
    Json::Value jsonData;
    string url(IEX_ENDPOINT);
    locale loc; //For isdigit
    if(!date.empty()) {
        if(date.size() == 8) {
